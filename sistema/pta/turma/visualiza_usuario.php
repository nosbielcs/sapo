          ...
          <td align="left" valign="top">
		    <table width="100%" border="0" cellpadding="0" cellspacing="0">
              ...
              <tr>
                ...
                <td height="42" bgcolor="#D5FFD5" width="100%" align="right"><a onClick="JavaScript: voltar();" style="cursor: pointer" class="link_verde">Voltar</a>&nbsp;</td>
              ...
              <tr>
                ...
                <td colspan="2" bgcolor="#D5FFD5">
				  <table width="95%" align="center" border="0" cellpadding="0" cellspacing="0">
					...
					<tr>
					  <td height="10"><input type="hidden" name="cod_turma" value="<?php echo $cod_turma; ?>"><input type="hidden" name="tipo_usuario" value="<?php echo $tipo_usuario; ?>"><input type="hidden" name="quantidade" value="<?php echo $limite; ?>"><input type="hidden" name="ordem" value="<?php echo $ordem; ?>"><input type="hidden" name="pagina" value="<?php echo $pag; ?>"></td>
					</tr>
					<tr>
					  <td align="center">
