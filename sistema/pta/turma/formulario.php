...
{	
	...
	$input_select = "<select name=\"curso_instituicao\" onChange=\"JavaScript: formularioTurma();\">";
	...
	for ($i = 0; $i < $total_cursos; $i++)
	{
		...
		if ($cod_curso == $cod_curso_instituicao)
			$input_select.= "<option value=\"".$cod_curso."\" selected>".$nome_curso."</option>";
		else
			$input_select.= "<option value=\"".$cod_curso."\">".$nome_curso."</option>";
	}
...
<body topmargin="0" leftmargin="0" onLoad="JavaScript: atualizaDiasdoMes('<?php echo $dia_inicio; ?>', '<?php echo $mes_inicio; ?>', '<?php echo $ano_inicio; ?>', 'turma_instituicao', 'dia_inicio'); atualizaDiasdoMes('<?php echo $dia_fim; ?>', '<?php echo $mes_fim; ?>', '<?php echo $ano_fim; ?>', 'turma_instituicao', 'dia_fim');">
						  ...
						  <tr>	
							<td valign="top">
							  ...
							  <table width="100%" height="100%" border="0" cellpadding="0" cellspacing="0">
								...
								<tr> 
								  <td width="130" class="preto" align="right" valign="top">Descri&ccedil;&atilde;o:</td>
								  <td width="10">&nbsp;</td>
