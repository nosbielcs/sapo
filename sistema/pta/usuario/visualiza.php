...
if ($_POST["cod_usuario_pta"])
{
	$cod_usuario_pta = $_POST["cod_usuario_pta"];
	$pertence = $_POST["modulo"];
	...
	switch ($pertence)
	{
		case "inscricao":
			...
			$sql = "SELECT cod_inscr, nome, cpf, email, data_nasc FROM inscritos WHERE cod_inscr = ".$cod_usuario_pta;
			$resultado = mysql_query($sql, $conexao);
			$nome = mysql_result($resultado, 0, "nome");
			$cpf = mysql_result($resultado, 0, "cpf");
			$email = mysql_result($resultado, 0, "email");
			$data_nasc = mysql_result($resultado, 0, "data_nasc");
          ...
          <td align="left" valign="top">
		    <table width="100%" border="0" cellpadding="0" cellspacing="0">
              ...
              <tr>
                ...
                <td height="42" bgcolor="#D5FFD5" width="100%" align="right"><?php if ($pertence == "sapo") { ?><a onClick="JavaScript: editarUsuario(<?php echo $cod_curso; ?>);" style="cursor: pointer" class="link_verde">Editar Usuário</a>&nbsp;<?php } ?></td>
              ...
              <tr>
                ...
                <td colspan="2" bgcolor="#D5FFD5">
				  <table width="95%" align="center" border="0" cellpadding="0" cellspacing="0">
					...
					<tr>
					  <td height="10"><input type="hidden" name="modulo" value="<?php echo $pertence; ?>"><input type="hidden" name="acao_usuario" value=""><input type="hidden" name="cod_usuario_pta"><input type="hidden" name="acao_voltar" value="visualiza"><input type="hidden" name="quantidade" value="<?php echo $limite; ?>"><input type="hidden" name="ordem" value="<?php echo $ordem; ?>"><input type="hidden" name="pagina" value="<?php echo $pag; ?>"></td>
					</tr>
					<tr>
					  <td align="center">
					    <table border="0" align="center" cellpadding="0" cellspacing="0">
						  <tr>
						    ...
						    <td bgcolor="#99FF99"><?php if ($pertence == "sapo") { ?><a onClick="JavaScript: editarUsuario(<?php echo $cod_usuario_pta; ?>);" onMouseOver="JavaScript: window.status = 'Editar Curso';" onMouseOut="JavaScript: window.status = 'SA²pO - Sistema de Apoio à Aprendizagem Online';" style="cursor:pointer" class="dcontexto"><span>Editar</span><img src="../../../imagens/icones/geral/tipo1/editar.gif" width="30" height="30" border="0" align="middle"></a> <?php } ?> &nbsp; <a onClick="JavaScript: voltar();" onMouseOver="JavaScript: window.status = 'Voltar';" onMouseOut="JavaScript: window.status = 'SA²pO - Sistema de Apoio à Aprendizagem Online';" style="cursor:pointer" class="dcontexto"><span>Voltar</span><img src="../../../imagens/icones/geral/tipo1/voltar.gif" width="30" height="30" border="0" align="middle"></a></td>
