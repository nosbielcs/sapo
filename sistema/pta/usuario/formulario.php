						  ...
						  <tr>	
							...
							<form name="tela_usuario_instituicao" action="controle.php" method="post">
							  <table width="100%" border="0" cellpadding="0" cellspacing="0">
								...
								<tr>
								  <td width="120" class="verde" align="right">Acesso:</td>
								  <td width="10"></td>
								  <td align="left"><select name="tipo_acesso">
								    ...
								    <option value="P" <?php if ($acesso_usuario == "C") echo "selected"; ?>>Supervisor do Sistema</option>
								  </select></td>
							    </tr>
								<?php
									}
								...
								<tr>
								  <td colspan="2"><input type="hidden" name="acao_usuario" value="<?php echo $acao_usuario; ?>"><input type="hidden" name="cod_usuario_pta" value="<?php echo $cod_usuario_pta; ?>"><input type="hidden" name="modulo" value="<?php echo $pertence; ?>"></td>
								<td>
