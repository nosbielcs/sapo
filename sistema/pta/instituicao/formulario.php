...
{		
	...
	$usuario_instituicao->carregar($cod_usuario_pta);
...
<body topmargin="0" leftmargin="0" onLoad="JavaScript: atualizaDiasdoMes('<?php echo $dia_nascimento; ?>', '<?php echo $mes_nascimento; ?>', '<?php echo $ano_nascimento; ?>', 'tela_usuario_pta', 'dia_nascimento');">
                    ...
                    <tr>
                      <td width="100%" bgcolor="#D5FFD5">
						...
						<table width="95%" align="center" border="0" cellspacing="0" cellpadding="0">
						  <tr>	
							<td valign="top">
							<form name="tela_usuario_pta" action="controle.php" method="post">
							  <table width="100%" border="0" cellpadding="0" cellspacing="0">
								<tr> 
								...
								<tr> 
								  ...
								  <td align="left">
								    ...
								    <select name="mes_nascimento" tabindex="6" onChange="JavaScript: atualizaDiasdoMes(document.tela_usuario_pta.dia_nascimento.value, document.tela_usuario_pta.mes_nascimento.value, document.tela_usuario_pta.ano_nascimento.value, 'tela_usuario_pta', 'dia_nascimento');">
								    ...
								    <select name="ano_nascimento" tabindex="7" onChange="JavaScript: atualizaDiasdoMes(document.tela_usuario_pta.dia_nascimento.value, document.tela_usuario_pta.mes_nascimento.value, document.tela_usuario_pta.ano_nascimento.value, 'tela_usuario_pta', 'dia_nascimento');">
									  <?php
											$ano_usuario = date("Y");
								...
								<tr> 
								  <td width="120" class="verde" align="right">Login e Senha:</td>
								  <td width="10">&nbsp;</td>
								  <td align="left">
									  <select name="usuario_instituicao_login_senha" tabindex="9">
										<option value="">Selecione uma Opção</option>
										<option value="gerar_nova">Gerar e Enviar Senha</option>
										<option value="enviar_senha">Enviar Senha Atual</option>
										<option value="cadastrar">Somente Cadastrar</option>
									  </select>
								  </td>
								</tr>
								<tr> 
								...
								<tr>
								  <td colspan="2"><input type="hidden" name="acao_usuario" value="editar"><input type="hidden" name="cod_usuario_pta" value="<?php echo $cod_usuario_pta; ?>"></td>
								<td>
