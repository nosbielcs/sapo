...
if (!empty($cod_forum))
{
	...
	if ($cod_editor != 0)
	{
		...
		$mensagem.= "<br><br><i>Este post foi Editado por <b>".$nome_usuario."</b>: ".$data_edicao.", ".$hora_edicao."</i>";
	}
								    ...
								    <td valign="top">
									  <table width="100%" cellpadding="0" cellspacing="0" border="0" bgcolor="#CCCCCC">
									    <tr>
										  ...
										  <td width="153" align="right" valign="middle">
										    <table width="153" cellpadding="0" cellspacing="0">
											  <tr>
												...
												<?php
													if ($cod_autor == $_SESSION["cod_usuario"])
													{
												?>
												<td width="5"></td>
									    ...
									    <tr>
										  <td width="5"></td>
										  <td colspan="2" class="cinza_simples" align="left"><?php echo citarMsgForum($mensagem, $smilies); ?></td>
										  <td width="5"></td>
									    </tr>
									  </table>
								    </td>
