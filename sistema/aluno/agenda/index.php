	...
	<td colspan="2" valign="top">
	  <table width="100%" border="0" cellpadding="0" cellspacing="0">
          ...
          <tr>
            ...
            <td height="42" bgcolor="#D7D9E5" width="100%" align="right"></td>
            ...
            <td colspan="2" bgcolor="#D7D9E5">
			  <table width="100%" border="0" cellpadding="1" cellspacing="2">
                <tr>
				 ...
				 <table width="95%" align="center">
					<tr>
					  <td><?php if ($limite == "todos") { ?><font class="preto">Página&nbsp;&nbsp;&nbsp;</font><font class="vermelho">1</font><?php } else echo paginacao($pagina, $inicio, $limite, $total_eventos, $url, true); ?></td>
