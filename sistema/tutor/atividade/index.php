		  ...
		  <table width="100%" border="0" cellpadding="1" cellspacing="2">
			<tr>
			  <td width="100%" bgcolor="#ffecce">
				...
				?>
				<tr>
				  <td align="center" class="vermelho_simples" colspan="2"><?php echo $_SESSION["mensagem_atividade"]; ?></td>
				</tr>
				<?php
				...
				<tr>
				  <td colspan="2">
					<table width="100%" border="0" cellpadding="0" cellspacing="0">
					  ...
					  <tr>
						<td width="30" align="center"><input type="checkbox" name="todas_atividades" onClick="marcaTodasAtividades('visualizaAtividade');"></td>
						<td colspan="6" class="laranja" align="left">&nbsp;Marcar/Desmarcar Todos</td>
					  </tr>
					<tr class="laranja_linha_1"> 
					  ...
					  <td class="preto" align="center">Data / Hora Entrega&nbsp;&nbsp;<?php
						  if ($_GET["ordem"])
							{ 
								$ordem = $_GET["ordem"];
					  ...
					  <td class="preto" align="center">Valor&nbsp;&nbsp;<?php
						  if ($_GET["ordem"])
							{ 
								$ordem = $_GET["ordem"];
					  ...
					  <td width="110" class="preto" align="center">Alunos / Entregues</td>
					</tr>
					<tr> 
					...
					<?php
						...
						for ($i = 0; $i < $total_atividades; $i++)
						{
							...
							//Verifica os Alunos que realizaram a Atividade
							if ($total_usuarios > 0)
								$usuarios_turma->primeiro();
								
							$total_entregues = 0;
							
							for ($j = 0; $j < $total_usuarios; $j++)
							{
								$cod_usuario = $usuarios_turma->data["cod_usuario"];
								...
								$usuarios_turma->proximo();
							}
					?>
					<tr>
				      <td height="1" class="<?php echo $cor_fundo; ?>"></td>
					</tr>
					<tr class="<?php echo $cor_fundo; ?>" id="<?php echo $cod_atividade; ?>"> 
					  <td align="center"><?php echo "<input type='checkbox' name='".$cod_atividade."' value='".$cod_atividade."' id='".$cor_fundo."' onClick=\"JavaScript: atualizaCodigosAtividade();\">"; ?></td>
					  ...
					  <td align="center" class="preto_simples"><?php echo "(".$total_usuarios."/".$total_entregues.")" ?></td>
					</tr>
					<tr>
				      <td height="1" class="<?php echo $cor_fundo; ?>"></td>
					</tr>
					  ...
					  <td colspan="7">
					    <table width="100%" align="center">
						  <tr>
						    ...
						    <td align="right"><font class="preto">Total&nbsp;&nbsp;&nbsp;</font><font class="vermelho"><?php echo $i."/"; ?></font><font class="preto"><?php echo $total_atividades; ?></font></td>
						  </tr>
					    </table>
					  </td>
					</tr>
					...
					<tr> 
					  <td colspan="7" height="15">
					    <input type="hidden" name="codigos_atividades" value="">
					...
					<tr> 
					  <td colspan="7">
					    <table align="center" border="0" cellspacing="0" cellpadding="0">
                          <tr>
                            <td height="34"><img src="../../../imagens/icones/avaliacao/lado_esquerda.gif" width="20" height="34"></td>
							<td height="34" bgcolor="#FFE3B9"><a onClick="JavaScript: editarAtividade();" onMouseOver="JavaScript: window.status = 'Editar Atividade';" onMouseOut="JavaScript: window.status = 'SA²pO - Sistema de Apoio à Aprendizagem Online';" title="Editar Atividade" style="cursor:pointer" class="dcontexto"><span>Editar</span><img src="../../../imagens/icones/geral/tipo1/editar.gif" width="30" height="30" border="0" align="middle"></a> &nbsp; <a onclick="JavaScript: excluirAtividade();" onMouseOver="JavaScript: window.status = 'Excluir Atividade';" onMouseOut="JavaScript: window.status = 'SA²pO - Sistema de Apoio à Aprendizagem Online';" title="Exlcuir Atividade" style="cursor:pointer" class="dcontexto"><span>Excluir</span><img src="../../../imagens/icones/geral/tipo1/excluir.gif" width="30" height="30" border="0" align="middle"></a></td>
							<td height="34"><img src="../../../imagens/icones/avaliacao/lado_direito.gif" width="20" height="34"></td>
                          </tr>
						</table>
					  </td>
					</tr>
			  ...
			  ?>
			    <table width="95%" border="0" align="center" cellpadding="0" cellspacing="0">
				  <form name="visualizaAtividade" action="atividade.php" method="post" target="_parent">
				  <tr> 
				    <td align="center" class="vermelho_simples">Nenhuma Atividade Cadastrada.<input type="hidden" name="acao"></td>
				  </tr>
				  </form>
				</table>
			  <?php
