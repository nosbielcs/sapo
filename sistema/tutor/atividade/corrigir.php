...
<script type="text/javascript">
	function voltar()
	{
		document.corrigir_atividade.action = "visualiza.php#topo";
			  ...
			  <td width="100%" bgcolor="#ffecce">
				...
				<?php
					...
					else
					{
						...
						$data_entrega = "Aguardando Correção";
						$data_correcao = "Aguardando Correção";
						$arquivo = "-";
						$nota = "";
						$comentario = "";
						...
						<tr>
						  <td>
							<table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="#FFE3B9">
							  ...
							  ?>
							  <tr>
								<td class="preto" align="right">Data de Envio:</td>
								<td>&nbsp;</td>
								<td class="laranja_simples" align="left"><?php echo $data_entrega; ?></td>
							  </tr>
							  <tr>
								<td colspan="3" height="15"></td>
							  </tr>
							  ...
							  <tr>
								<td class="preto" align="right">Descri&ccedil;&atilde;o:</td>
								<td>&nbsp;</td>
							  ...
							  <tr>
								...
								<td>&nbsp;</td>
								<td class="laranja_simples" align="left"><input type="text" maxlength="10" size="12" name="nota_atividade" value="<?php echo $nota; ?>"></td>
							  </tr>
							  <tr>
							  ...
							  <tr>
								...
								<td>&nbsp;</td>
								<td class="laranja_simples" valign="top" align="left"><textarea name="comentario_atividade" cols="45" rows="8"><?php echo $comentario; ?></textarea></td>
							  </tr>
							  <tr>
								<td colspan="3" height="15"></td>
							  </tr>
							  <tr>
								...
								<td class="laranja_simples" align="left">
								  <select name="situacao_atividade">
									<option value="A" <?php if ($verifica == "A") echo "selected"; ?>>Aguardando Correção</option>
									<option value="C" <?php if ($verifica == "C") echo "selected"; ?>>Corrigido</option>
									<option value="R" <?php if ($verifica == "R") echo "selected"; ?>>Refazer</option>
								  </select>
								</td>
							  </tr>
							  <tr>
