	...
	<td colspan="2" valign="top">
	  <table width="100%" border="0" cellpadding="0" cellspacing="0">
		...
		<tr>
		  ...
		  <td height="42" align="right" bgcolor="#E8E8E8" width="100%"><a onClick="JavaScript: novoForum();" onMouseOver="JavaScript: window.status = 'Adicionar novo Tópico para Debate';" onMouseOut="JavaScript: window.status = 'SA²pO - Sistema de Apoio à Aprendizagem Online';" style="cursor: pointer" class="link_cinza">Novo T&oacute;pico para Debate</a></td>
		    ...
		    <table width="100%" border="0" cellpadding="1" cellspacing="2" bgcolor="#E8E8E8">
			  <tr>
				<td width="100%">
				  ...
				  <?php 
						if (isset($_SESSION["mensagem_forum"]))
						{
					  ?>
				  <tr>
					<td align="center" class="vermelho_simples"><?php echo $_SESSION["mensagem_forum"]; ?></td>
				  </tr>
				  <?php
							unset($_SESSION["mensagem_forum"]);
						}
				  ?>
				  <tr>
					<td valign="top" align="center">
					  <table width="100%" border="0" cellpadding="0" cellspacing="0">
								  ...
								  <tr>
								    ...
								    <td valign="top">
									  <table width="100%" cellpadding="0" cellspacing="0" border="0" bgcolor="#CCCCCC">
									    <tr>
										  <td width="5"></td>
										  <td align="left"><font class="cinza_simples"><?php echo $data_forum." ".$hora_forum; ?></font>&nbsp;<font class="cinza">Assunto:</font>&nbsp;<font class="cinza_simples"><?php echo nl2br($assunto); ?></font></td>
										  <td width="230" align="right" valign="middle">
										    <table width="230" cellpadding="0" cellspacing="0">
											  <tr>
												<td align="right"><a onClick="JavaScript: exibirResponderForum(<?php echo $cod_forum; ?>, <?php echo $cod_forum; ?>, 'forum', 'citar');" onMouseOver="JavaScript: window.status = 'Citar Mensagem';" onMouseOut="JavaScript: window.status = 'SA²pO - Sistema de Apoio à Aprendizagem Online';" style="cursor:pointer"><img src="../../../imagens/icones/forum/citar.gif" width="72" height="24" border="0"></a></td>
												<td width="5"></td>
												<td align="center"><a onClick="JavaScript: editarForum(<?php echo $cod_forum; ?>);" onMouseOver="JavaScript: window.status = 'Editar Mensagem';" onMouseOut="JavaScript: window.status = 'SA²pO - Sistema de Apoio à Aprendizagem Online';" style="cursor:pointer"><img src="../../../imagens/icones/forum/editar.gif" width="72" height="24"></a></td>
												<td width="5"></td>
												<td align="left"><a onClick="JavaScript: excluirForum(<?php echo $cod_forum; ?>);" onMouseOver="JavaScript: window.status = 'Excluir Mensagem';" onMouseOut="JavaScript: window.status = 'SA²pO - Sistema de Apoio à Aprendizagem Online';" style="cursor:pointer"><img src="../../../imagens/icones/forum/excluir.gif" width="72" height="24"></a></td>
											  </tr>
											</table>
										  </td>
										  <td width="5"></td>
								  ...
								  <tr>
								    ...
								    <td valign="top">
									  <table width="100%" align="left" cellpadding="0" cellspacing="0" border="0" bgcolor="#CCCCCC">
									    <tr>
										  <td width="5"></td>
										  <td align="left"><font class="cinza_simples"><?php echo $data_mensagem." ".$hora_mensagem; ?></font>&nbsp;<font class="cinza">Assunto:</font>&nbsp;<font class="cinza_simples"><?php echo $assunto_mensagem; ?></font></td>
										  <td width="230" align="right">
										    <table width="230" cellpadding="0" cellspacing="0">
											  <tr>
												<td align="right"><a onClick="JavaScript: exibirResponderForum(<?php echo $cod_forum; ?>, <?php echo $cod_mensagem; ?>, 'mensagem', 'citar');" onMouseOver="JavaScript: window.status = 'Citar Mensagem';" onMouseOut="JavaScript: window.status = 'SA²pO - Sistema de Apoio à Aprendizagem Online';" style="cursor:pointer"><img src="../../../imagens/icones/forum/citar.gif" width="72" height="24" border="0"></a></td>
												<td width="5"></td>
												<td align="center"><a onClick="JavaScript: editarMsgForum(<?php echo $cod_mensagem ; ?>, <?php echo $cod_forum; ?>);" onMouseOver="JavaScript: window.status = 'Editar Mensagem';" onMouseOut="JavaScript: window.status = 'SA²pO - Sistema de Apoio à Aprendizagem Online';" style="cursor:pointer"><img src="../../../imagens/icones/forum/editar.gif" width="72" height="24"></a></td>
												<td width="5"></td>
												<td align="left"><a onClick="JavaScript: excluirMsgForum(<?php echo $cod_mensagem; ?>);" onMouseOver="JavaScript: window.status = 'Exlcluir Mensagem';" onMouseOut="JavaScript: window.status = 'SA²pO - Sistema de Apoio à Aprendizagem Online';" style="cursor:pointer"><img src="../../../imagens/icones/forum/excluir.gif" width="72" height="24"></a></td>
											  </tr>
											</table>
										  </td>
										  <td width="5"></td>
						...
						<tr>
						  <td align="left" colspan="2"><?php echo $paginas; ?></td>
						</tr>
						<tr>
						  <td height="10" colspan="2"></td>
						</tr>
						<tr>
						  <td class="cinza" align="left">Resposta r&aacute;pida</td>
						  <td align="right"><a onClick="JavaScript: window.location.href = '#topo'" onMouseOver="JavaScript: window.status = 'Voltar ao Topo desta Página';" onMouseOut="JavaScript: window.status = 'SA²pO - Sistema de Apoio à Aprendizagem Online';" style="cursor: pointer" class="link_cinza">Voltar ao Topo desta Página</a></td>
						</tr>
						<tr>
						  <td valign="top" colspan="2">
							<table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="#CCCCCC" class="cinza_borda">
							  <tr>
									  ...
									  <td>
										<table width="100%" cellpadding="0" cellspacing="0" border="0">
										  <tr>
											...
											<?php 
												$tabela_smilies = montaTabelaSmilies($smilies, "../../../imagens/icones/smilies/", "tela_forum", "forum", "vertical", "#E8E8E8"); 
												echo $tabela_smilies; 
											?>
											</td>
											<td valign="top">
											  <table width="100%" cellpadding="0" cellspacing="0">
												<tr>
												  <td valign="top">
													<table width="100%" cellpadding="0" cellspacing="0">
													  <tr>
														<td width="80" valign="top" align="right" class="preto">Mensagem:</td>
														<td width="5">&nbsp;</td>
														<td valign="top" align="left"><textarea name="mensagem" cols="40" rows="12"></textarea></td>
													  </tr>
													  <tr>
													    <td></td>
														<td colspan="2">
														  <table align="left" border="0" cellspacing="0" cellpadding="0">
															...
															<tr>
															  ...
															  <td height="34" bgcolor="#E8E8E8"><a onClick="JavaScript: enviaRespostaForum();" onMouseOver="JavaScript: window.status = 'Enviar Mensagem';" onMouseOut="JavaScript: window.status = 'SA²pO - Sistema de Apoio à Aprendizagem Online';" style="cursor:pointer" class="dcontexto"><span>Enviar</span><img src="../../../imagens/icones/geral/tipo1/enviar.gif" width="30" height="30" border="0" align="middle"></a> &nbsp; <a onClick="JavaScript: voltar();" onMouseOver="JavaScript: window.status = 'Voltar';" onMouseOut="JavaScript: window.status = 'SA²pO - Sistema de Apoio à Aprendizagem Online';" style="cursor:pointer" class="dcontexto"><span>Voltar</span><img src="../../../imagens/icones/geral/tipo1/voltar.gif" width="30" height="30" border="0" align="middle"></a></td>
