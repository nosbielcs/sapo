			...
			<tr>
			  <td width="100%">
				...
				<tr>
				  ...
				  <table width="100%" border="0" cellpadding="0" cellspacing="0">
					...
					<?php 
					  ...
					  ?>
					<tr>
					  <td align="center" class="vermelho_simples" colspan="3"><?php echo $_SESSION["mensagem_forum"]; ?></td>
					</tr>
					<?php
				...
				<tr>
				  <td>
					...
					<form name="tela_forum" action="forum.php" method="post" target="_parent">
					<tr>
					  <td width="25" align="center"><input type="checkbox" name="todos_forum" onClick="JavaScript: marcaTodosForum('tela_forum');"></td>
					  <td width="20">&nbsp;</td>
					  <td colspan="5" class="cinza">Marcar/Desmarcar Todos</td>
					</tr>
					<tr bgcolor="#CCCCCC"> 
						    ...
						    <td width="25%" class="preto">Tópico&nbsp;&nbsp;<?php 
								...
								{ 
									...
									switch($ordem) 
									{
										case 1:
											...
											echo "<a onClick=\"JavaScript: window.location.href = '".$url_ordena_topico."'\" title=\"Ordem Crescente por Tópico\" onMouseOver=\"JavaScript: window.status = 'Ordem Crescente por Tópico';\" onMouseOut=\"JavaScript: window.status = 'SA²pO - Sistema de Apoio à Aprendizagem Online';\" style=\"cursor: pointer\"><img src=\"../../../imagens/outros/seta_ordenar.gif\" border=\"0\"></a>";
										break;
										...
										case 6:
											...
											echo "<a onClick=\"JavaScript: window.location.href = '".$url_ordena_topico."'\" title=\"Ordem Decrescente por Tópico\" onMouseOver=\"JavaScript: window.status = 'Ordem Decrescente por Tópico';\" onMouseOut=\"JavaScript: window.status = 'SA²pO - Sistema de Apoio à Aprendizagem Online';\" style=\"cursor: pointer\"><img src=\"../../../imagens/outros/seta_ordenar_1.gif\" border=\"0\"></a>";
										break;
								...
								{ 
									...
									switch($ordem) 
									{
										case 1:
											...
											echo "<a onClick=\"JavaScript: window.location.href = '".$url_ordena_respostas."'\" title=\"Ordem Crescente por Total de Respostas\" onMouseOver=\"JavaScript: window.status = 'Ordem Crescente por Total de Respostas';\" onMouseOut=\"JavaScript: window.status = 'SA²pO - Sistema de Apoio à Aprendizagem Online';\" style=\"cursor: pointer\"><img src=\"../../../imagens/outros/seta_ordenar.gif\" border=\"0\"></a>";
										break;
							  ...
							  <td width="25%" align="left" class="preto">Última Mensagem&nbsp;&nbsp;<?php
								...
								{ 
									...
									switch($ordem) 
									{
										case 1:
											...
											echo "<a onClick=\"JavaScript: window.location.href = '".$url_ordena_data."'\" title=\"Ordem Decrescente por &Uacute;ltima Mensagem\" onMouseOver=\"JavaScript: window.status = 'Ordem Decrescente por &Uacute;ltima Mensagem';\" onMouseOut=\"JavaScript: window.status = 'SA&sup2;pO - Sistema de Apoio &agrave; Aprendizagem Online';\" style=\"cursor: pointer\"><img src=\"../../../imagens/outros/seta_ordenar.gif\" border=\"0\"></a>";
										break;
										
										case 2: 
											$url_ordena_data.= "&ordem=1";
											echo "<a onClick=\"JavaScript: window.location.href = '".$url_ordena_data."'\" title=\"Ordem Crescente por &Uacute;ltima Mensagem\" onMouseOver=\"JavaScript: window.status = 'Ordem Crescente por &Uacute;ltima Mensagem';\" onMouseOut=\"JavaScript: window.status = 'SA&sup2;pO - Sistema de Apoio &agrave; Aprendizagem Online';\" style=\"cursor: pointer\"><img src=\"../../../imagens/outros/seta_ordenar_1.gif\" border=\"0\"></a>";
										break;
								...
								else
								{
									...
									echo "<a onClick=\"JavaScript: window.location.href = '".$url_ordena_exibicoes."'\" title=\"Ordem Crescente por &Uacute;ltima Mensagem\" onMouseOver=\"JavaScript: window.status = 'Ordem Crescente por &Uacute;ltima Mensagem';\" onMouseOut=\"JavaScript: window.status = 'SA&sup2;pO - Sistema de Apoio &agrave; Aprendizagem Online';\" style=\"cursor: pointer\"><img src=\"../../../imagens/outros/seta_ordenar.gif\" border=\"0\"></a>";
								}
							  ?></td>
						  </tr>
					    </table>
					...
					?>
					<tr>
				      <td height="1" colspan="3" class="<?php echo $cor_fundo; ?>"></td>
					</tr>
					<tr class="<?php echo $cor_fundo; ?>" id="<?php echo $cod_forum; ?>">
					  <td align="center"><?php echo "<input type='checkbox' name='".$cod_forum."' value='".$cod_forum."' id='".$cor_fundo."' onClick=\"JavaScript: atualizaCodigosForum();\">"; ?></td>
					...
					<tr> 
					  <td colspan="3">
					    <input type="hidden" name="codigosForum" value="">
					  ...
					  <td colspan="3">
					    <table align="center" border="0" cellspacing="0" cellpadding="0">
						  <tr>
						    ...
						    <td height="34" bgcolor="#CCCCCC"><a onClick="JavaScript: editarForum('');" onMouseOver="JavaScript: window.status = 'Editar Fórum';" onMouseOut="JavaScript: window.status = 'SA²pO - Sistema de Apoio à Aprendizagem Online';" style="cursor: pointer" class="dcontexto"><span>Editar</span><img src="../../../imagens/icones/geral/tipo1/editar.gif" width="30" height="30" border="0" align="middle"></a> &nbsp; <a onclick="JavaScript: excluirForum('');" onMouseOver="JavaScript: window.status = 'Excluir';" onMouseOut="JavaScript: window.status = 'SA²pO - Sistema de Apoio à Aprendizagem Online';" style="cursor: pointer" class="dcontexto"><span>Excluir</span><img src="../../../imagens/icones/geral/tipo1/excluir.gif" width="30" height="30" border="0" align="middle"></a></td>
			  ...
			  ?>
			    <table width="95%"  border="0" align="center" cellpadding="0" cellspacing="0">
				  <form name="tela_forum" action="forum.php" method="post" target="_parent">
				  <tr> 
				    <td align="center" class="vermelho_simples">Nenhum Tópico Cadastrado.<input type="hidden" name="acao"></td>
				  </tr>
				  </form>
				</table>
			  <?php
