		    ...
		    <table width="100%" border="0" cellpadding="1" cellspacing="2">
			  <tr>
			    <td width="100%" bgcolor="#CFE7B8">
					...
					<tr>
					  <td colspan="2">
						<table width="100%" border="0" cellpadding="0" cellspacing="0">
						  ...
						  ?>
						  <tr>
							<td width="30" align="center"><input type="checkbox" name="todas_salas_bate_papo" onClick="JavaScript: marcaTodasSalasBatePapo('salas_bate_papo');"></td>
							<td colspan="6" class="verde" align="left">&nbsp;Marcar/Desmarcar Todas</td>
						  </tr>
						<tr bgcolor="#99CC66"> 
						  <td class="preto" align="center">&nbsp;</td>
						...
						<tr class="<?php echo $cor_fundo; ?>" id="<?php echo $cod_sala; ?>"> 
						  <td align="center"><?php echo "<input type='checkbox' name='".$cod_sala."' value='".$cod_sala."' id='".$cor_fundo."' onClick=\"JavaScript: atualizaSalasBatePapo();\">"; ?></td>
						  <td align="center" class="preto_simples"><?php echo $data_sala; ?></td>
						  <td><a OnClick="<?php echo $link_sala; ?>" onMouseOver="JavaScript: window.status = 'Acessar Sala de Bate Papo';" onMouseOut="JavaScript: window.status = 'SA²pO - Sistema de Apoio à Aprendizagem Online';" style="cursor: pointer" class="link_verde"><?php echo $nome_sala; ?></a></td>
						...
						<tr> 
						  <td colspan="7">
						    <table border="0" align="center" cellpadding="0" cellspacing="0">
                              <tr>
                                <td height="34"><div align="right"><img src="../../../imagens/icones/bate_papo/lado_esquerda1.gif" width="20" height="34"></div></td>
                                <td height="34" bgcolor="#99CC66"><a onclick="JavaScript: editarSalaBatePapo();" onMouseOver="JavaScript: window.status = 'Editar Sala de Bate Papo';" onMouseOut="JavaScript: window.status = 'SA²pO - Sistema de Apoio à Aprendizagem Online';" style="cursor: pointer" class="dcontexto"><span>Editar</span><img src="../../../imagens/icones/geral/tipo1/editar.gif" alt="" width="30" height="30" border="0" align="middle"></a> &nbsp; <a onclick="JavaScript: encerrarSalaBatePapo();" onMouseOver="JavaScript: window.status = 'Encerrar Sala de Bate Papo';" onMouseOut="JavaScript: window.status = 'SA²pO - Sistema de Apoio à Aprendizagem Online';" style="cursor: pointer" class="dcontexto"><span>Encerrar</span><img src="../../../imagens/icones/geral/tipo1/encerrar.gif" width="30" height="30" border="0" align="middle"></a> &nbsp; <a onclick="JavaScript: excluirSalaBatePapo();" onMouseOver="JavaScript: window.status = 'Excluir Sala de Bate Papo';" onMouseOut="JavaScript: window.status = 'SA²pO - Sistema de Apoio à Aprendizagem Online';" style="cursor: pointer" class="dcontexto"><span>Excluir</span><img src="../../../imagens/icones/geral/tipo1/excluir.gif" width="30" height="30" border="0" align="middle"></a></td>
                                <td height="34"><div align="left"><img src="../../../imagens/icones/bate_papo/lado_direita1.gif" width="20" height="34"></div></td>
                              </tr>
                            </table>
						  </td>
						</tr>
				  ...
				  <form name="salas_bate_papo" action="controle.php" method="post">
					<tr>
					  <td align="center" class="vermelho_simples"><input type="hidden" name="cor_mensagem" value=""><input type="hidden" name="codigosSalasBatePapo" value="">Nenhuma Sala de Bate Papo Cadastrada.<input type="hidden" name="acao_bate_papo" value=""><input type="hidden" name="cod_sala_bate_papo" value=""></td>
					</tr>
				  </form>
				  <?php
					}
