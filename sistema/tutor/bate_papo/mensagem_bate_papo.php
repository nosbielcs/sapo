		  ...
		  <td colspan="11">
		    <table width="100%" cellpadding="0" cellspacing="0">
			  <tr>
				...
				<td width="10">&nbsp;</td>
		  		<td width="80" class="preto_simples"><input type="checkbox" name="bate_papo_rolagem" id="rolagem_bate_papo" value="rolagem" <?php if ($_SESSION["rolagem"] == "S") echo "checked"; ?>>Rolagem</td>
				<td width="10">&nbsp;</td>
