	...
	<td colspan="2" valign="top">
	  <table width="100%" border="0" cellpadding="0" cellspacing="0">
        ...
        <tr>
          ...
          <td height="42" bgcolor="#F5E2EC" width="100%" align="right"><a onClick="JavaScript: novoConteudo();" class="link_magenta" onMouseOver="JavaScript: window.status = 'Novo Conteúdo';" onMouseOut="JavaScript: window.status = 'SA²pO - Sistema de Apoio à Aprendizagem Online';" style="cursor:pointer">Novo Conteúdo</a></td>
              ...
              <tr>
                <td width="100%" bgcolor="#F5E2EC">
				  ...
				  <table width="95%" border="0" cellspacing="0" cellpadding="0" align="center">
					...
					<?php 
						if (isset($_SESSION["mensagem_conteudo"]))
						{
					  ?>
					<tr>
				      <td align="center" class="vermelho_simples" colspan="2"><?php echo $_SESSION["mensagem_conteudo"]; ?></td>
					</tr>
					<?php
							unset($_SESSION["mensagem_conteudo"]);
						}
					?>
					<tr>
					  <td colspan="2">
						...
						<tr>
						  <td width="30" align="center"><input type="checkbox" name="todos_conteudos" onClick="marcaTodosConteudos('mostra_conteudo');"></td>
						...
						<tr bgcolor="#E8BBD1"> 
								...
								{ 
									...
									switch($ordem) 
									{
										case 1:
											...
											echo "<a onClick=\"JavaScript: window.location.href = '".$url_ordena_tamanho."'\" title=\"Ordem Crescente por Tamanho do Conteúdo\" onMouseOver=\"JavaScript: window.status = 'Ordem Crescente por Tamanho do Conteúdo';\" onMouseOut=\"JavaScript: window.status = 'SA²pO - Sistema de Apoio à Aprendizagem Online';\" style=\"cursor:pointer\"><img src=\"../../../imagens/outros/seta_ordenar.gif\" border=\"0\"></a>";
										break;
										...
										case 5:
											$url_ordena_tamanho.= "&ordem=6";
											echo "<a onClick=\"JavaScript: window.location.href = '".$url_ordena_tamanho."'\" title=\"Ordem Decrescente por Tamanho do Conteúdo\" onMouseOver=\"JavaScript: window.status = 'Ordem Decrescente por Tamanho do Conteúdo';\" onMouseOut=\"JavaScript: window.status = 'SA²pO - Sistema de Apoio à Aprendizagem Online';\" style=\"cursor:pointer\"><img src=\"../../../imagens/outros/seta_ordenar.gif\" border=\"0\"></a>";
										break;
						  ...
						  ?></td>
						  <td width="90" class="preto" align="center">Permiss&otilde;es</td>
						</tr>
						<tr> 
						...
						<?php
							...
							for ($i = 0; $i < $total_conteudo; $i++)
							{
								...
								if ($tipo_conteudo != "site")
								{
									...
									$permissoes = "<a onClick=\"JavaScript: permissaoConteudo('".$pagina."', '".$limite."', '".$ordem."', '".$cod_conteudo."');\" class=\"link_magenta\" onMouseOver=\"JavaScript: window.status = 'Permissões do Conteúdo ".$descricao_conteudo."';\" onMouseOut=\"JavaScript: window.status = 'SA²pO - Sistema de Apoio à Aprendizagem Online';\" style=\"cursor:pointer\">Editar</a>";					
								}
								else
								{
									$tamanho = "-";
						...
						<tr class="<?php echo $cor_fundo; ?>" id="<?php echo $cod_conteudo; ?>">
						  <td align="center"><?php echo "<input type='checkbox' name='".$cod_conteudo."' value='".$cod_conteudo."' id='".$cor_fundo."' onClick=\"JavaScript: atualizaCodigosConteudo();\">"; ?></td>
						  <?php
							if ($tipo_conteudo == "site")
							{
								if ($cod_hierarquia != 0)
						  ...
						  <td align="center" class="preto_simples"><?php echo $permissoes; ?></td>
						</tr>
						<tr>
						  <td height="1" colspan="6" class="<?php echo $cor_fundo; ?>"></td>
						</tr>
						...
						<tr> 
						  <td>&nbsp;</td>
						  <td colspan="3" class="preto_simples" align="right">Espaço Utilizado desta Página:</td>
						  <td align="center" class="preto"><?php echo tamanhoArquivo($tamanho_por_pagina); ?></td>
						  <td>&nbsp;</td>
						</tr>
						<tr> 
						  <td>&nbsp;</td>
						  <td colspan="3" class="preto_simples" align="right">Espaço Total Utilizado:</td>
						  <td align="center" class="preto"><?php echo tamanhoArquivo($tamanho_total_conteudos); ?></td>
						  <td>&nbsp;</td>
						</tr>
						<tr> 
						  <td>&nbsp;</td>
						  <td colspan="3" class="preto_simples" align="right">Espaço Total Disponível:</td>
						  ...
						  <td colspan="6">
						    <table align="center" border="0" cellspacing="0" cellpadding="0">
							  <tr>
							    ...
							    <td height="34" bgcolor="#E8BBD1"><a onClick="JavaScript: editarConteudo();" onMouseOver="JavaScript: window.status = 'Editar Conteúdo';" onMouseOut="JavaScript: window.status = 'SA²pO - Sistema de Apoio à Aprendizagem Online';" style="cursor:pointer" class="dcontexto"><span>Editar</span><img src="../../../imagens/icones/geral/tipo1/editar.gif" alt="Editar Conteúdo" width="30" height="30" border="0" align="middle"></a> &nbsp; <a onClick="JavaScript: excluirConteudo();" onMouseOver="JavaScript: window.status = 'Excluir Conteúdo';" onMouseOut="JavaScript: window.status = 'SA²pO - Sistema de Apoio à Aprendizagem Online';" style="cursor:pointer" class="dcontexto"><span>Excluir</span><img src="../../../imagens/icones/geral/tipo1/excluir.gif" alt="Excluir Conteúdo" width="30" height="30" border="0" align="middle"></a></td>
