...
else
{
	$url_ordenacao.= "&ordem=2";
	$url_paginacao = "index.php?pag=".$pagina;
	$link_ordenacao = "<a onClick=\"window.location.href = '".$url_ordenacao."'\" title=\"Ordem Crescente por Data\" onMouseOver=\"JavaScript: window.status = 'Ordem Crescente por Data';\" onMouseOut=\"JavaScript: window.status = 'SA²pO - Sistema de Apoio à Aprendizagem Online';\" style=\"cursor: pointer\"><img src=\"../../../imagens/outros/seta_ordenar.gif\" border=\"0\"></a>";
}
?>
<html>
<head>
	...
	<td colspan="2" valign="top">
		<table width="100%" border="0" cellpadding="0" cellspacing="0">
          ...
          <tr>
            ...
            <td height="42" bgcolor="#F7E3DB" width="100%" align="right"><a onClick="JavaScript: novoEdital(<?php echo $pagina; ?>, <?php echo $limite; ?>, <?php echo $ordem; ?>);" onMouseOver="JavaScript: window.status = 'Novo Edital';" onMouseOut="JavaScript: window.status = 'SA²pO - Sistema de Apoio à Aprendizagem Online';" style="cursor: pointer" class="link_marron">Novo Edital</a></td>
					...
					?>
							  ...
							  <td>
								<table width="100%" align="center">
								  <tr> 
									...
									<td width="10">&nbsp;</td>
									<td class="marron_simples" width="100%"><?php echo $assunto; ?></td>
								  </tr>
								  <tr>
									<td width="70" class="preto" valign="top" align="right">Mensagem:</td>
									<td width="10">&nbsp;</td>
									<td class="marron_simples" width="100%"><?php echo nl2br($mensagem); ?></td>
								  </tr>
								  <tr>
									...
									<td colspan="3">
									  <table border="0" align="center" cellpadding="0" cellspacing="0">
									    <tr>
										  ...
										  <td height="34" bgcolor="#F7E3DB"><a onClick="JavaScript: editarEdital(<?php echo $cod_edital; ?>, <?php echo $pagina; ?>, <?php echo $limite; ?>, <?php echo $ordem; ?>);" onMouseOver="JavaScript: window.status = 'Editar Edital';" onMouseOut="JavaScript: window.status = 'SA²pO - Sistema de Apoio à Aprendizagem Online';" style="cursor: pointer" class="dcontexto"><span>Editar</span><img src="../../../imagens/icones/geral/tipo1/editar.gif" alt="Editar" width="30" height="30" border="0" align="middle"></a> &nbsp; <a onClick="JavaScript: excluirEdital(<?php echo $cod_edital; ?>, <?php echo $pagina; ?>, <?php echo $limite; ?>, <?php echo $ordem; ?>, '<?php echo $assunto; ?>');" onMouseOver="JavaScript: window.status = 'Excluir Edital';" onMouseOut="JavaScript: window.status = 'SA²pO - Sistema de Apoio à Aprendizagem Online';" style="cursor: pointer" class="dcontexto"><span>Excluir</span><img src="../../../imagens/icones/geral/tipo1/excluir.gif" alt="Excluir" width="30" height="30" border="0" align="middle"></a></td>
					  ...
					  <tr>
					    <td>
						  <table width="100%" align="center">
						    <tr>
							  <td><?php if ($limite == "T") { ?><font class="preto">Página&nbsp;&nbsp;&nbsp;</font><font class="vermelho">1</font><?php } else echo paginacao($pagina, $inicio, $qtd_listagem, $total_editais, $url, true); ?></td>
