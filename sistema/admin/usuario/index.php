...
$usuario_instituicao->colecaoUsuarioInstituicao($cod_inst, "I");
	
$quantidade = $usuario_instituicao->linhas;
...
$usuario_instituicao->paginacaoInstituicao($cod_inst, "I", $limite, $inicio, $ordem);
$total_usuario = $usuario_instituicao->linhas;
?>
<html>
<head>
          ...
          <td align="left" valign="top">
		    <table width="100%" border="0" cellpadding="0" cellspacing="0">
              ...
              <tr>
                ...
                <td height="42" bgcolor="#D5FFD5" width="100%" align="right"><a onClick="JavaScript: novoUsuario();" style="cursor: pointer" class="link_verde">Novo Usuario</a>&nbsp;</td>
              ...
              <tr>
                ...
                <td colspan="2" bgcolor="#D5FFD5">
					...
					<tr>
					  ...
					  <table width="100%" border="0" cellpadding="0" cellspacing="0">
						<tr>
						  ...
						  <td width="10">&nbsp;</td>
						  <td width="50">
							<select name="qtd_listagem" onChange="JavaScript: paginacaoUsuariosInstituicao('<?php echo $url_ordenacao; ?>', 'paginacao_usuario');">
					...
					<tr>
					  <td>
						...
						<form name="tela_usuario_instituicao" method="post">
						  <tr> 
							<td width="30" align="center"><input type="checkbox" name="todos_usuario" onClick="marcaTodosUsuario('tela_usuario_instituicao');"></td>
							<td width="10">&nbsp;</td>
						  ...
						  <?php
							...
							{
								$cod_usuario = $usuario_instituicao->data["cod_usuario"];
								$usuario = new usuario();
						...
						?>
						  <tr class="<?php echo $cor_fundo; ?>"> 
							<td align="center"><?php echo "<input type='checkbox' name='".$cod_usuario."' value='".$cod_usuario."' onClick=\"atualizaCodigosUsuario();\">"; ?></td>
							<td>&nbsp;</td>
							<td><a OnClick="JavaScript: visualizaUsuario(<?php echo $cod_usuario; ?>)" style="cursor: pointer" class="link_verde"><?php echo $nome; ?></a></td>
						  </tr>
						  <?php
								$usuario_instituicao->proximo();
							}
						  ?>
						  <tr> 
							<td colspan="3" height="10"></td>
						  ...
						  <tr> 
							<td colspan="3"><input type="hidden" name="codigos_usuarios" value=""><input type="hidden" name="acao_usuario" value=""><input type="hidden" name="cod_usuario" value=""><input type="hidden" name="acao_voltar" value="index"><input type="hidden" name="quantidade" value="<?php echo $limite; ?>"><input type="hidden" name="ordem" value="<?php echo $ordem; ?>"><input type="hidden" name="pagina" value="<?php echo $pag; ?>"></td>
						  </tr>
						  <tr> 
							<td colspan="3"> 
							  <table width="100%" cellpadding="0" cellspacing="0">
				  ...
				  ?>
				    <tr>
					  <td class="verde_simples" align="center"><form name="tela_usuario_instituicao" method="post"><input type="hidden" name="acao_usuario" value="">Nenhum Usuário Encontrado.</form></td>
					</tr>
				  <?php
				  	}
				  ?>
