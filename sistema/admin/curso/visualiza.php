          ...
          <td align="left" valign="top">
		    <table width="100%" border="0" cellpadding="0" cellspacing="0">
              ...
              <tr>
                ...
                <td height="42" bgcolor="#D5FFD5" width="100%" align="right"><a onClick="JavaScript: editarCurso(<?php echo $cod_curso; ?>);" style="cursor: pointer" class="link_verde">Editar Curso</a>&nbsp;</td>
              ...
              <tr>
                ...
                <td colspan="2" bgcolor="#D5FFD5">
				  <table width="95%" align="center" border="0" cellpadding="0" cellspacing="0">
					...
					<tr>
					  <td height="10"><input type="hidden" name="acao_curso" value=""><input type="hidden" name="cod_curso"><input type="hidden" name="acao_voltar" value="visualiza"><input type="hidden" name="quantidade" value="<?php echo $limite; ?>"><input type="hidden" name="ordem" value="<?php echo $ordem; ?>"><input type="hidden" name="pagina" value="<?php echo $pag; ?>"></td>
					</tr>
					<tr>
					  <td align="center">
