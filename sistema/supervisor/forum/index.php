				  ...
				  <td>
					...
					<tr class="<?php echo $cor_fundo; ?>" id="<?php echo $cod_forum; ?>">
					  ...
					  <td>
					    <table width="100%" cellpadding="0" cellspacing="0">
						  <tr> 
						    <td width="25%"><a OnClick="JavaScript: lerForum(<?php echo $cod_forum; ?>, 'forum')" title="<?php echo $topico_c; ?>" onMouseOver="JavaScript: window.status = 'Ler Fórum';" onMouseOut="JavaScript: window.status = 'SA²pO - Sistema de Apoio à Aprendizagem Online';" style="cursor: pointer" class="<?php echo $estilo; ?>"><?php echo $topico; ?></a></td>
