						...
						<tr>
						  <td>
							<table width="100%" border="0" cellpadding="0" cellspacing="0">
							  ...
							  <tr>
								<td colspan="3" height="15"><input type="hidden" name="cod_atividade" value="<?php echo $cod_atividade; ?>"><input type="hidden" name="cod_aluno" value="<?php echo $cod_atividade; ?>"><input type="hidden" name="acao" value="editar"><input type="hidden" name="acao_voltar" value="visualiza"><input type="hidden" name="pagina" value="<?php echo $pagina; ?>"><input type="hidden" name="quantidade" value="<?php echo $quantidade; ?>"><input type="hidden" name="ordem" value="<?php echo $ordem; ?>"><input type="hidden" name="filtro" value="<?php echo $filtro; ?>"></td>
							  </tr>
							  <tr>
								<td colspan="3">
							...
							<table width="100%" border="0" cellpadding="0" cellspacing="0">
							  ...
							  <?php
								  	for ($j = 0; $j < $total_usuarios; $j++)
									{
										...
										{
											$link_corrigir = "<a onClick=\"JavaScript: corrigirAtividade(".$cod_atividade.", ".$cod_usuario.")\" class=\"link_laranja\" onMouseOver=\"JavaScript: window.status = '".$nome." não entregou a Atividade';\" onMouseOut=\"JavaScript: window.status = 'SA²pO - Sistema de Apoio à Aprendizagem Online';\" style=\"cursor:pointer\" title='".$nome." não entregou a Atividade'>".$nome."</a>";
											//$link_corrigir = $nome;
