...
<table border="0" cellpadding="0" cellspacing="0" width="100%">
  ...
  <tr>
	...
	<td height="24" bgcolor="#FFDFAE" width="100%" align="right"><a onClick="JavaScript: abas('ultimosTopicos');" style="cursor: pointer"><img id="imagem_topicos" name="minimizar" title="Minimizar Últimas no Fórum" src="../../../imagens/outros/nodeclose.jpg" border="0"></a>&nbsp;</td>
				    ...
				    <tr>
					  <td class="laranja_simples">
					    <select name="turma_cat_lst">
						  ...
						  <option value="S" <?php if ($turma_cat_lst == "S") echo "selected"; ?>>Suporte Técnico</option>
				    ...
				    <tr>
					  <td>
					    <select name="turma_qtd_lst">
						  <option value="" <?php if (empty($turma_qtd_lst)) echo "selected"; ?>>Padrão do Sistema</option>
				    ...
				    <tr>
					  <td class="laranja_simples">
					    <select name="turma_ordem">
						  <option value="" <?php if (empty($turma_ordem)) echo "selected"; ?>>Padrão do Sistema</option>
