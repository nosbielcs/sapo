...
<table border="0" cellpadding="0" cellspacing="0" width="100%">
  ...
  <tr>
	...
	<td height="24" bgcolor="#E8E8E8" width="100%" align="right"><a onClick="JavaScript: abas('ultimosTopicos');" style="cursor: pointer"><img id="imagem_topicos" name="minimizar" title="Minimizar Últimas no Fórum" src="../../../imagens/outros/nodeclose.jpg" border="0"></a>&nbsp;</td>
	  ...
	  <table width="100%" border="0" cellpadding="0" cellspacing="0">
				    ...
				    <tr>
					  <td>
					    <select name="forum_qtd_lst">
						  <option value="" <?php if (empty($forum_qtd_lst)) echo "selected"; ?>>Padrão do Sistema</option>
		...
		<tr>
		  <td width="50%" valign="top">
		    <table width="100%" border="0" cellpadding="0" cellspacing="0">
			  <tr>
			    <td class="preto" width="120" align="right">Ordenação:</td>
			    <td width="10"></td>
			    <td>
				  <table width="100%" border="0" cellpadding="0" cellspacing="0">
				    <tr>
					  <td class="preto_simples">
					    <select name="forum_ordem">
						  <option value="" <?php if (empty($forum_ordem)) echo "selected"; ?>>Padrão do Sistema</option>
						  <option value="6" <?php if ($forum_ordem == 6) echo "selected"; ?>>Crescente por Tópico</option>
						  <option value="5" <?php if ($forum_ordem == 5) echo "selected"; ?>>Decrescente por Tópico</option>
						  ...
						  <option value="10" <?php if ($forum_ordem == 10) echo "selected"; ?>>Crescente por Exibições</option>
						  <option value="9" <?php if ($forum_ordem == 9) echo "selected"; ?>>Decrescente por Exibições</option>
